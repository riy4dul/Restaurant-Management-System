...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($image))
        {
            ...
            if (!file_exists('frontend/images/item'))
            {
                mkdir('frontend/images/item',0777,true);
            }
            $image->move('frontend/images/item',$imagename);
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($image))
        {
            ...
            unlink('frontend/images/item/'.$item->image);
            $image->move('frontend/images/item',$imagename);
        }else{
    ...
    {
        $item = Item::find($id);
        if (file_exists('frontend/images/item/'.$item->image))
        {
            unlink('frontend/images/item/'.$item->image);
        }
        $item->delete();
