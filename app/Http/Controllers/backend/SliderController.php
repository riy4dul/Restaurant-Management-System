...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($image))
        {
            ...
            if (!file_exists('frontend/images/slider'))
            {
                mkdir('frontend/images/slider', 0777 , true);
            }
            $image->move('frontend/images/slider',$imagename);
        }else {
    ...
    {
         $slider = Slider::find($id);
        if (file_exists('frontend/images/slider/'.$slider->image))
        {
            unlink('frontend/images/slider/'.$slider->image);
        }
        $slider->delete();
